...
export const UpdateBannerCarousel: React.FC<UpdateBannerCarouselProps> = ({ className }) => {
  ...
  return (
    <div className={cn('relative overflow-hidden rounded-2xl border border-emerald-500/25 bg-card p-6 shadow-sm', className)}>
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-emerald-500/[0.07] to-transparent" />
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex-1">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
              ...
              <Link
                href="/changelog"
                className="inline-flex items-center gap-1 text-emerald-700 transition-colors hover:text-emerald-800 dark:text-emerald-200 dark:hover:text-emerald-100"
              >
                View changelog
          ...
          <div className="mt-5 flex items-center justify-between border-t border-border pt-4">
            <div className="flex items-center gap-2">
              <button
                type="button"
                onClick={goPrev}
                className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-border bg-card text-muted-foreground transition-colors hover:border-emerald-300 hover:text-emerald-600 dark:hover:text-emerald-300"
